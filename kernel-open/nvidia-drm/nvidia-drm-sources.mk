...
NV_CONFTEST_FUNCTION_COMPILE_TESTS += drm_connector_attach_encoder_present
NV_CONFTEST_FUNCTION_COMPILE_TESTS += drm_connector_update_edid_property_present
NV_CONFTEST_FUNCTION_COMPILE_TESTS += drm_connector_attach_colorspace_property_present
...
NV_CONFTEST_TYPE_COMPILE_TESTS += vmf_insert_mixed_has_unsigned_long_pfn_arg
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_mode_create_hdmi_colorspace_property_has_supported_colorspaces_arg
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_helper_mode_fill_fb_struct_has_format_info_arg
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_mode_config_funcs_has_fb_create_with_format_info_arg
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_atomic_state_has_new_state_fields
