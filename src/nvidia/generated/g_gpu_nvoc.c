...
} // End __nvoc_init_funcTable_OBJGPU_2 with approximately 50 basic block(s).


// Initialize vtable(s) for 111 virtual method(s).
void __nvoc_init_funcTable_OBJGPU(OBJGPU *pThis) {

    // Initialize vtable(s) with 111 per-object function pointer(s).
